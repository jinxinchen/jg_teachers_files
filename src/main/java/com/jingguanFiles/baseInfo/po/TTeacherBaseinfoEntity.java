...
public class TTeacherBaseinfoEntity {
    ...
    public String getIsMoreLangue() {
        return isMoreLangue;
    }

    public void setIsMoreLangue(String isMoreLangue) {
    ...
    public String getAcademicSecretary() {
        return academicSecretary;
    }

    public void setAcademicSecretary(String academicSecretary) {
